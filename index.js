const songsJSON = [
    ...
    { songTitle: "Vikram Title Track", songBy: "Vikram", audio: "audio/Vikram Title Track.mp3", industry: "Tamil", img:"images/vikram.jpg",index:7},
    { songTitle: "BadAss", songBy: "Leo", audio:"audio/Badass Leo.mp3" , industry: "Tamil", img:"./images/badass-leo.jpg",index:8},
    { songTitle: "Hukum", songBy: "Jailer", audio:"audio/Hukum.mp3" , industry: "Tamil", img:"./images/hukum.jpg" , index:9},
];
...
industryDropdown.addEventListener("change", () => {
    ...
    switch (industryDropdown.value) {
        ...
        case "telugu":
            ...
            break;
        case "tamil":
            // If "tamil" is selected, display Tamil songs
